...
const MAX_LINKS = 30
// 사진 20장 + 움짤 여유분을 합친 서버 안전판(2026-08-13 신설, 2026-09-05 10→20 확대에
// 맞춰 같이 올림). lib/boardImage.ts의 MAX_IMAGES와 별개 — 이 값을 안 맞추면 클라이언트가
// 20장을 다 붙였는데 서버가 조용히 15장에서 잘라버린다.
const MAX_ATTACHED_IMAGES = 25
