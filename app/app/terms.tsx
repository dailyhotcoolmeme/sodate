    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 40 }]}>
        ...
        <Text style={styles.body}>
          ...
          ※ 2026년 9월 2일 개정: 제휴 및 광고에 관한 조항(제2조의2)을 신설하고, 제2조의 서비스 범위를 실제 운영에 맞게 수정했습니다.{'\n'}
        ...
        <Text style={styles.body}>
          {'\n'}서비스는 소개팅·모임을 직접 운영하거나 주최하지 않으며, 혼술바 등 오프라인 매장을 직접 운영하지 않습니다. 신청·예약이 필요한 경우 각 업체의 페이지로 연결하는 아웃링크만을 제공합니다. 다만 서비스는 일부 업체·매장과 제휴할 수 있으며, 이에 관한 사항은 제2조의2에서 정합니다.
        </Text>

        <Text style={styles.sectionTitle}>제2조의2 (제휴 및 광고)</Text>
        <Text style={styles.bullet}>
          • 서비스는 일부 업체·매장과 제휴할 수 있으며, 제휴 중인 곳은 앱 화면에 별도로 표시합니다.{'\n'}
          • 제휴 혜택(할인·서비스 등)은 해당 업체·매장이 이용자에게 직접 제공하는 것입니다. 혜택의 내용·조건과 그 이행에 대한 책임은 해당 업체·매장에 있으며, 서비스는 혜택의 제공을 보증하지 않습니다. 혜택이 제공되지 않은 경우 이용자는 서비스에 알릴 수 있고, 서비스는 제휴 표시 중단 등 필요한 조치를 할 수 있습니다.{'\n'}
          • 서비스는 화면 상단 배너 등의 광고를 게재할 수 있으며, 광고에는 광고임을 알리는 표시를 합니다.{'\n'}
          • 제휴 여부는 일정·매장의 노출 순서에 영향을 주지 않습니다. 목록의 정렬은 이용자가 선택한 정렬 기준에 따릅니다.
        </Text>
