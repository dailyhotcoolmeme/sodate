...
/**
 * 혼술바 탭 — 아직 준비 중 화면(2026-08-21). 4탭 껍데기 단계.
 * 실제 목록은 다음 단계에서 채운다(공공데이터+네이버 플레이스).
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.center}>
        <Ionicons name="wine-outline" size={40} color={colors.textTertiary} />
        <Text style={styles.title}>혼술바</Text>
