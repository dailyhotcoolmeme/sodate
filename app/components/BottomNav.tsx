...
import { HeartIcon, GroupIcon, ChatIcon, CocktailIcon, UserCircleIcon, EventPhotoIcon, SocialingPhotoIcon, HonsulPhotoIcon, BoardPhotoIcon, type IconProps } from '@/components/TabIcons'
