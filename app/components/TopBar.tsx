...
export default function TopBar({
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    // 하트+"소밋"이 한 이미지로 된 워드마크(648x231 = 2.81:1).
    ...
    // 소개팅|커뮤니티 알약(글자 14)과 덩치를 맞춘다. 648x231 = 2.81:1 이라
    // 높이 24 에 맞는 폭은 67 이다.
    // ⚠️ 글자 높이는 하트의 85%(196/231). 원래 '소개팅모아' 비율(159/231=69%)을 그대로
    //    쓰니 두 글자뿐이라 하트보다 작아 보인다는 지적이 있어 키웠다(2026-08-31).
    logoWordmark: { width: 67, height: 24 },
