 ...
 * ⚠️ 아이콘마다 원본 여백이 달라 그냥 담으면 탭바에서 위아래 선이 안 맞는다
 *    (2026-08-31 오너 지적). assets/make-tabicon.py 가 **잉크 세로 높이를 캔버스의
 *    82%로 통일**해 뽑으므로, 새 아이콘도 반드시 그 스크립트로 만들 것.
 *    옆으로 더 넓은 아이콘이 들어오면 그 82% 값을 낮춰 전체를 다시 뽑아야 한다.
